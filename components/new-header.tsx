                            ...
                            <>
                                ...
                                <div className="p-4 space-y-2 overflow-y-auto max-h-[calc(100vh-80px)]">
                                    <button
                                        ...
                                        className="w-full py-3 px-4 text-sm font-bold text-pink-500 cursor-pointer hover:bg-pink-50 rounded-lg transition-all duration-200 text-left transform hover:scale-105"
                                    ...
                                    {Object.entries(categories).slice(1).map(([categoryName, subcategories], index) => (
                                        <button
                                            ...
                                            className="w-full py-3 px-4 text-sm text-black cursor-pointer hover:bg-gray-50 rounded-lg transition-all duration-200 flex items-center justify-between group transform hover:scale-105"
