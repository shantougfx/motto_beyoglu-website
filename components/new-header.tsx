                                ...
                                <div className="p-4 space-y-2 animate-fadeIn">
                                    {categories[activeSubcategory as keyof typeof categories].map((subcategory, index) => (
                                        <button
                                            ...
                                            className="w-full py-3 px-4 text-sm text-gray-600 cursor-pointer hover:bg-gray-50 rounded transition-all duration-200 text-left hover-underline transform hover:scale-105 opacity-0"
