                            ...
                            <>
                                ...
                                <div className="p-4 space-y-2 overflow-y-auto max-h-[calc(100vh-80px)]">
                                    <button
                                        ...
                                        className="w-full py-3 px-4 text-sm font-bold text-pink-500 cursor-pointer hover:bg-pink-50 rounded-lg transition-colors duration-200 text-left"
                                    ...
                                    {Object.entries(categories).slice(1).map(([categoryName, subcategories], index) => (
                                        <button
                                            ...
                                            className="w-full py-3 px-4 text-sm text-black cursor-pointer hover:bg-gray-50 rounded-lg transition-colors duration-200 flex items-center justify-between group"
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <a href="/urunler" onClick={handleCloseSidebar} className="w-full py-2 px-4 text-sm text-gray-600 hover:text-black hover:bg-gray-50 rounded-lg transition-colors duration-200 flex items-center gap-3">
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                                            </svg>
                                            Tüm Ürünler
                                        </a>
                                        <a href="/iletisim" onClick={handleCloseSidebar} className="w-full py-2 px-4 text-sm text-gray-600 hover:text-black hover:bg-gray-50 rounded-lg transition-colors duration-200 flex items-center gap-3">
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                                            </svg>
                                            İletişim
                                        </a>
                                        <a href="https://wa.me/905348246584" target="_blank" rel="noopener noreferrer" className="w-full py-2 px-4 text-sm text-green-600 hover:text-green-700 hover:bg-green-50 rounded-lg transition-colors duration-200 flex items-center gap-3">
